...
from . import views
from .views import verificar_roles_usuario
...
urlpatterns = [
    ...
    path(
        "perfil/publico/<int:user_id>/",
        views.obtener_perfil_publico,
        name="perfil_publico",
    ),
    path("perfil/actualizar/", views.actualizar_perfil, name="actualizar_perfil"),
    path(
        "perfil/estadisticas/", views.estadisticas_usuario, name="estadisticas_usuario"
    ),
    path("verificar-roles/", verificar_roles_usuario, name="verificar-roles"),
    # ==========================================
    ...
    path(
        "ubicacion/actualizar/", views.actualizar_ubicacion, name="actualizar_ubicacion"
    ),
    ...
    path(
        "direcciones/<uuid:direccion_id>/",
        views.detalle_direccion,
        name="detalle_direccion",
    ),
    path(
        "direcciones/predeterminada/",
        views.direccion_predeterminada,
    ...
    path(
        "metodos-pago/<uuid:metodo_id>/",
        views.detalle_metodo_pago,
        name="detalle_metodo_pago",
    ),
    path(
        "metodos-pago/predeterminado/",
        views.metodo_pago_predeterminado,
    ...
    # ==========================================
    path(
        "solicitudes-cambio-rol/",
        views.mis_solicitudes_cambio_rol,
        name="mis-solicitudes",
    ),
    path(
        "solicitudes-cambio-rol/<uuid:solicitud_id>/",
        views.detalle_solicitud_cambio_rol,
