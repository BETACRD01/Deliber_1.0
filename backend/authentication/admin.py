...
class CustomUserAdmin(BaseUserAdmin):
    ...
    list_display = [
        'email', 'username', 'full_name', 'celular', 
        'is_active', 'cuenta_desactivada', 'created_at'
    ]
    
    list_filter = [
        'is_active', 'cuenta_desactivada', 'terminos_aceptados',
    ...
    readonly_fields = [
        ...
        'fecha_desactivacion', 'ultimo_login_ip',
        'intentos_login_fallidos', 'cuenta_bloqueada_hasta',
        'reset_password_expire', 'reset_password_attempts'
    ]
    ...
    def resetear_preferencias_notificaciones(self, request, queryset):
        ...
        self.message_user(request, f"📧 {updated} usuarios con notificaciones activadas")
    resetear_preferencias_notificaciones.short_description = "📧 Activar todas las notificaciones"
