// lib/screens/auth/forms/registro_repartidor_form.dart
...
class RegistroRepartidorForm extends StatefulWidget {
  const RegistroRepartidorForm({super.key});

  @override
  State<RegistroRepartidorForm> createState() => _RegistroRepartidorFormState();
}

class _RegistroRepartidorFormState extends State<RegistroRepartidorForm> {
  ...
  String _formatearFechaParaMostrar() {
    if (_fechaNacimiento == null) return 'Selecciona tu fecha';
  ...
  Future<void> _registrar() async {
    ...
    if (_calcularEdad() < 18) {
      setState(() => _error = 'Debes ser mayor de 18 años para ser repartidor');
      return;
    }
    ...
    try {
      ...
      final data = {
        ...
        'rol': 'REPARTIDOR', // ⭐ ROL: Necesita completar datos del vehículo
      };

      // 🐛 DEBUG
      debugPrint('📦 ============ REGISTRO REPARTIDOR ============');
      debugPrint('Rol: REPARTIDOR (debe completar datos del vehículo)');
      ...
      if (mounted) {
          ...
          SnackBar(
            content: Column(
              ...
              children: [
                ...
                Text(
                  '⚠️ Completa los datos de tu vehículo en tu perfil',
        ...
        // ✅ CORRECCIÓN: Usar Router para redirigir a pantalla de repartidor
              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    _buildSeccion(
                      '1. Responsabilidades',
                      'Entregas puntuales y en perfecto estado.',
                    ),
                    _buildSeccion(
                      '2. Documentación',
                      'Licencia vigente y vehículo en buenas condiciones.',
                    ),
                    _buildSeccion(
                      '3. Horarios',
                      'Configura tu disponibilidad libremente.',
                    ),
                    _buildSeccion(
                      '4. Pagos',
                      'Pagos semanales por cada entrega completada.',
                    ),
                    _buildSeccion(
                      '5. Verificación',
              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    _buildSeccion(
                      '1. Datos',
                      'Recopilamos información personal y del vehículo.',
                    ),
                    _buildSeccion(
                      '2. Uso',
                      'Para asignar pedidos y procesar pagos.',
                    ),
                    _buildSeccion('3. Seguridad', 'Protegemos tu información.'),
                    _buildSeccion(
                      '4. Derechos',
  ...
  Widget _buildCampo({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        labelText: label,
        hintText: hint,
        prefixIcon: Icon(icono, color: _naranjaOscuro, size: 22),
        counterText: '',
          ...
          child: RichText(
            text: TextSpan(
              ...
              children: [
                ...
                TextSpan(
                  text: 'Términos para Repartidores',
                  style: const TextStyle(
                    color: _naranja,
                    fontWeight: FontWeight.bold,
